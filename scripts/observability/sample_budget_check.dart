...
void main(List<String> args) async {
  final lines = <String>[];
  await stdin.transform(utf8.decoder).transform(const LineSplitter()).forEach(lines.add);
  ...
  stdout.writeln('search_success_rate: ${metrics.searchSuccessRate().toStringAsFixed(3)}');
