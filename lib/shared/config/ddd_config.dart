class DddConfig {
  ...
  static const String kAttachmentsMaxItemMb = 'ddd.cache.attachments.max_item_mb';
  ...
  static int get attachmentsMaxItemBytes => _attachmentsMaxItemMbDefault * 1024 * 1024;
