...
class ModernDraftOptionsSheet extends StatelessWidget {
            ...
            child: Column(
              children: [
                ...
                _buildOptionTile(
                  ...
                  subtitle: controller.isHtml.value 
  ...
  String _getPriorityText() {
    switch (controller.priority.value) {
      case 1: return 'low_priority'.tr;
      case 2: return 'high_priority'.tr;
      case 3: return 'urgent_priority'.tr;
      default: return 'normal_priority'.tr;
    }
  }
  ...
  void _showCategoryDialog(BuildContext context) {
    ...
    final categories = [
      ...
      {'key': 'follow_up', 'icon': Icons.follow_the_signs, 'color': Colors.orange},
  ...
  void _showPriorityDialog(BuildContext context) {
    final theme = Theme.of(context);
    final priorities = [
      {'level': 0, 'label': 'normal'.tr, 'color': Colors.grey, 'icon': Icons.remove},
      {'level': 1, 'label': 'low'.tr, 'color': Colors.blue, 'icon': Icons.keyboard_arrow_down},
      {'level': 2, 'label': 'high'.tr, 'color': Colors.orange, 'icon': Icons.keyboard_arrow_up},
      {'level': 3, 'label': 'urgent'.tr, 'color': Colors.red, 'icon': Icons.priority_high},
    ];
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: priorities.map((priority) => Padding(
            padding: const EdgeInsets.only(bottom: 8),
            child: Obx(() => Material(
              color: Colors.transparent,
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      if (controller.priority.value == priority['level'])
                        Icon(
                          Icons.check_circle,
                          color: theme.colorScheme.primary,
                        ),
