...
abstract class SyncModule {
  ...
  SyncService provideSyncService(
    ImapGateway gateway,
    dom.MessageRepository messages,
  ) => SyncService(
    gateway: gateway,
    messages: messages,
  ...
  @LazySingleton()
  SyncScheduler provideSyncScheduler(SyncService service) =>
      SyncScheduler(service);

  @LazySingleton()
  BgFetchIos provideBgFetchIos(
    dom.MessageRepository messages,
    CircuitBreaker cb,
    SyncEventBus bus,
  ...
  @LazySingleton()
  ConnectivityMonitor provideConnectivityMonitor(
    dom.MessageRepository messages,
    CircuitBreaker cb,
