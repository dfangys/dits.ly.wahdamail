...
class HiveMailboxMimeStorage extends OfflineMimeStorage {
  HiveMailboxMimeStorage({
    ...
    required Mailbox mailbox,
        ...
        _mailbox = mailbox,
        _boxNameIds = getBoxName(mailAccount, mailbox, 'ids'),
        _boxNameEnvelopes = getBoxName(mailAccount, mailbox, 'envelopes'),
        _boxNameFullMessages = getBoxName(mailAccount, mailbox, 'full');
