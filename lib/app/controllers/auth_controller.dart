...
class AuthController extends GetxController {
  ...
  void onInit() {
    ...
    // Initialize background tasks if authenticated
  ...
  /// Initialize background tasks for email checking
  void _initializeBackgroundTasks() {
    try {
      if (Get.isRegistered<BackgroundTaskController>()) {
        final backgroundTaskController = Get.find<BackgroundTaskController>();
        backgroundTaskController.initializeBackgroundTasks();
        backgroundTaskController.registerPeriodicEmailChecks();
      } else {
        // Delay initialization if controller not yet registered
  ...
  Future<bool> login(String email, String password) async {
    try {
      ...
      // Initialize background tasks after successful login
      _initializeBackgroundTasks();

      // Register background callback for workmanager
