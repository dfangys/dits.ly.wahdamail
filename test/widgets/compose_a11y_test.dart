...
void main() {
  ...
  testWidgets('Compose a11y: semantics labels and 44dp min targets for key actions', (tester) async {
    ...
    expect(tester.getSize(find.byTooltip('Attach file')).height >= 44, isTrue);
