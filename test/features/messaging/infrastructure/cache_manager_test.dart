...
void main() {
  test('AttachmentCacheManager denies storing > max per item (100MB default)', () async {
  ...
  test('BodyCacheManager evicts least-recent while protecting flagged', () async {
    final store = InMemoryLocalStore();
    ...
    await store.upsertBody(BodyRow(messageUid: 'm1', mimeType: 'text/plain', plainText: 'x' * 9000));
    await store.upsertBody(BodyRow(messageUid: 'm2', mimeType: 'text/plain', plainText: 'y' * 9000));
