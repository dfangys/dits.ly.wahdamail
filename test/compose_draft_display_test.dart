...
void main() {
  ...
  testWidgets(
    'RedesignedComposeScreen displays draft subject, recipients, body, and attachments',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        GetMaterialApp(home: RedesignedComposeScreen(draft: draft)),
      );
      ...
      expect(
        controller.plainTextController.text,
        equals('This is the body content.'),
      );
    ...
    skip:
        true, // Requires platform plugins (GetStorage/path_provider) not available in unit test environment
  );
}
